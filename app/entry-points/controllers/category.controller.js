...
import CreateCategoryDTO from '../../domain/dto/createCategoryDTO.js';
import GetAllRequestDTO from '../../domain/dto/getAllRequestDTO.js';
import UpdateCategoryDTO from '../../domain/dto/updateCategoryDTO.js';
...
class CategoryController {
   ...
   async createCategory(req, res, next) {
    try {
      ...
      return res.status(successCode.CATEGORY_CREATED.httpStatusCode).json(response);
    } catch (error) {
      next(error);
    }
  }
   ...
   async getCategories(req, res, next) {
    try {
      ...
      const categoriesResponse = await this.categoryService.getCategories(getCategoryRequest);
      ...
      return res.status(successCode.CATEGORIES_GET_ALL.httpStatusCode).json(response);
    } catch (error) {
      next(error);
    }
  }
   ...
   async updateCategoryById(req, res, next) {
    try {
      ...
      const category = await this.categoryService.updateCategoryById(req.params.id, updateCategoryData);
      const response = APIResponse.success(
        successCode.CATEGORY_UPDATED.code,
        successCode.CATEGORY_UPDATED.message,
        category
      );
      return res.status(successCode.CATEGORY_UPDATED.httpStatusCode).json(response);
    } catch (error) {
      next(error);
    }
  }
   ...
   async deleteCategoryById(req, res, next) {
    try {
      ...
      return res.status(successCode.CATEGORY_DELETED.httpStatusCode).json(response);
    } catch (error) {
      next(error);
    }
  }
